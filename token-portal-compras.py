...
class OnDemandTokenServer:
    def __init__(self):
        ...
        self.url = 'https://pncp.gov.br/app/editais/57356434000146/2025/5'
    ...
    def _initialize_browser(self):
        ...
        try:
            ...
            # Simply wait for page load - no need to loop
            time.sleep(2)
    ...
    def _generate_token(self):
        ...
        try:
            token = self.driver.execute_async_script(js_to_get_token)
            duration = time.time() - start_time
            
            # Reset hCaptcha for next request
            ...
            return token.get("response") or "", duration
        except Exception as e:
            duration = time.time() - start_time
            error_msg = str(e)
